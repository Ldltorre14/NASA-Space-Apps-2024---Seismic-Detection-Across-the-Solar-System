...
#   TEST DATA
LUNAR_TEST_DATA_S12_GRADE_B = "./data/lunar/test/data/S12_GradeB"
LUNAR_TEST_DATA_S15_GRADE_A = "./data/lunar/test/data/S15_GradeA"
...
#   TRAINING DATA
LUNAR_TRAINING_CATALOG_DIRECTORY = "./data/lunar/training/catalogs"
LUNAR_TRAINING_DATA_DIRECTORY = "./data/lunar/training/data/S12_GradeA"
LUNAR_TRAINING_PLOTS_DIRECTORY = "./data/lunar/training/plots"